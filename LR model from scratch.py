...
x = x.set_index('Date')
y = pd.read_csv(r'tmwVIXFUT Close values.csv')
y = y.set_index('Date')
...
y['tmwVIXFUT Close'].value_counts(sort=False, ascending=True)
...
outOfSample_startdate= '2015-06-03'
trainSize= 1000
poly_degree= 'na'
ploy_interaction_only_TrueFalse= 'na'
LR_penaly_l1l2= 'none'
LR_c= 'na'
...
#LRfit('2015-06-03', 1000, 2, False, 'l2', 10)- best one
